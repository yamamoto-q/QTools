...
module.exports = React.createClass({
	...
	render: function() {
		...
		if(this.state.staredApps.length > 0){
			...
			staredApps.push(
				<li key={"apps-summary-stared-apps-info"} className="list-group-item justify-content-between">
		...
		return(
			<div className="card card-apps-summary" onClick={this.onClick} data-viewname={Controller_View.ViewNames.APPS}>
				<div className="card-block card-block-header">
